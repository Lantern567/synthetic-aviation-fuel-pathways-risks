...
### 异常处理测试 (2024-12-19)
| 测试用例 | 机型 | 距离(km) | 旅客数 | 燃油(kg) | 状态 | 计算方法 |
|----------|------|----------|---------|----------|------|----------|
| 正常A320 | A320 | 800      | 150     | 3,160.6  | ✅   | 备用算法 |
| 正常B737 | B737 | 1,200    | 140     | 3,970.6  | ✅   | 备用算法 |
| 未知机型 | UNKNOWN | 1,000 | 150     | 3,592.7  | ✅   | 备用算法 |
| 虚假机型 | FAKE123 | 500   | 100     | 2,245.8  | ✅   | 备用算法 |
| 极短距离 | A320 | 50       | 1       | 1,042.0  | ✅   | 备用算法 |
| 极长距离 | A320 | 10,000   | 300     | 32,892.5 | ✅   | 备用算法 |
| 零乘客   | A320 | 1,000    | 0       | 2,750.1  | ✅   | 备用算法 |
| 空机型名 | (空)  | 1,000    | 150     | 3,592.7  | ✅   | 备用算法 |
| 特殊字符 | A320@#$ | 1,000  | 150     | 3,592.7  | ✅   | 备用算法 |
