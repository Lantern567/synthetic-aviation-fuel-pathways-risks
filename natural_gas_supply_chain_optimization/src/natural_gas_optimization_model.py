...
class NaturalGasSupplyChainOptimizer:
    ...
    def __init__(self, time_horizon_weeks: int = 1, use_graphhopper_routing: bool = True, 
        ...
        if use_graphhopper_routing:
            # 创建缓存目录
            cache_dir = os.path.join(get_project_base_dir(), "cache", "graphhopper_routes")
            ...
            logger.info("GraphHopper路径规划引擎初始化完成")
        else:
            raise ValueError("必须使用GraphHopper本地路径规划，请设置use_graphhopper_routing=True")
    ...
    def _load_real_renewable_data(self) -> pd.DataFrame:
        ...
        wind_data_dir = os.path.join(base_dir, "resource_flight_data_process", "results", "3hourly_generation")
        solar_data_dir = os.path.join(base_dir, "resource_flight_data_process", "results", "solar_generation")
    ...
    def _process_airport_data(self, airport_data: pd.DataFrame):
        ...
        # 构建绝对路径
        base_dir = get_project_base_dir()
        excel_path = os.path.join(base_dir, "resource_flight_data_process", "results", "flights_beijing_tianjing", "all_airports_weekly_parameters_20250726_142747.xlsx")
    ...
    def _load_ng_pipeline_data(self):
        ...
        try:
            ...
            base_dir = get_project_base_dir()
            integrated_file = os.path.join(base_dir, "natural_gas_supply_chain_optimization", "data", "integrated_gas_pipeline_price_data_with_coords.csv")
    ...
    def _load_original_pipeline_data(self):
        ...
        try:
            # 使用相对路径的真实GIS数据
            base_dir = get_project_base_dir()
            pipeline_file = os.path.join(base_dir, "gis_data_scraper", "scraped_gis_data", "natural_gas_pipelines.csv")
    ...
    def _load_lng_terminal_data(self):
        ...
        try:
            ...
            # 使用相对路径的真实GIS数据
            base_dir = get_project_base_dir()
            lng_file = os.path.join(base_dir, "gis_data_scraper", "scraped_gis_data", "lng_terminals.csv")
...
if __name__ == '__main__':
    ...
    try:
        ...
        # 构建相对路径到机场数据文件
        base_dir = get_project_base_dir()
        airport_excel_path = os.path.join(str(base_dir), "resource_flight_data_process", "results", "flights_beijing_tianjing", "all_airports_weekly_parameters_20250726_142747.xlsx")
        ...
        if solution:
            ...
            # 保存结果到results目录
            base_dir = get_project_base_dir()
            results_dir = os.path.join(base_dir, "natural_gas_supply_chain_optimization", "results")
